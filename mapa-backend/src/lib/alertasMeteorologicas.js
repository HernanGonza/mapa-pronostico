...
const iconos = [{id:'tormentas-severas',nombre:'Tormentas severas'},{id:'vientos-fuertes',nombre:'Vientos fuertes'},{id:'granizo',nombre:'Granizo'},{id:'inundacion',nombre:'Inundación'}];
