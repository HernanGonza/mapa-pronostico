...
export default function CuencasPage() {
  ...
  return <div className="admin-layout cuencas-claro">
    ...
    <section className="admin-panel" id="contenido-principal" tabIndex={-1}>
      ...
      <p className="admin-panel__hint">Usá el enlace de cada tarjeta para abrir el Monitor Hidrológico oficial en una pestaña nueva.</p>
      <EmbedShare path="/embed/cuencas-tarjetas" title="Monitor de cuencas · tarjetas · Misiones" height={780}
        heading="Tarjetas para el sitio web" hint="Estado, caudal y localidades de cada río. Las fuentes se consultan cada 5 minutos; la fecha de medición se muestra en cada lectura."
