...
export class CameraDirector {
  constructor(scene, canvas) {
    ...
    this.camera.lowerRadiusLimit = 20; this.camera.upperRadiusLimit = 350; this.camera.lowerBetaLimit = .25; this.camera.upperBetaLimit = 1.48;
    this.camera.wheelPrecision = 18; this.camera.panningSensibility = 120; this.camera.attachControl(canvas, true);
  }
  flyTo(target, municipal = true, reduced = false) {
    ...
    Animation.CreateAndStartAnimation("radiusFlight", this.camera, "radius", 30, frames, this.camera.radius, municipal ? 48 : 155, 1, undefined, () => { this.flightProgress = 1; this.orbit = true; });
