...
export class SceneManager {
  ...
  setPolitical({world,provinces,countryLabels,provinceLabels,municipios}) { this.political.clear();this.political.addCountries(world);this.political.addBoundaries(world,{color:new Color3(.5,.7,.62),y:.22});this.political.addBoundaries(provinces,{color:new Color3(.38,.52,.47),y:.34,dashed:true});this.political.addLabels(countryLabels,{size:10,y:2.2,color:"#b9c9bf"});this.political.addLabels(provinceLabels,{size:6,y:1.8,color:"#d6e2da"});this.political.addMunicipalityLabels(municipios); }
